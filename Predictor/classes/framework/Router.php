    ...
    public function selectController($selected_route)
    {
        switch ($selected_route)
        {
            ...
            case 'predictions-made':
                ...
                break;
            case 'results':
                $controller = Factory::buildObject('ResultsController');
                break;
            case 'leagues':
            ...
            case 'leave-league':
                ...
                break;
            case 'join-league':
                $controller = Factory::buildObject('JoinLeagueController');
                break;
            case 'league-detail':
                $controller = Factory::buildObject('LeagueDetailsController');
                break;
            ...
            case 'registered':
                ...
                break;
            case 'create-league':
                $controller = Factory::buildObject('CreateLeagueController');
                break;
            case 'logout':
            case 'login':
            case 'login-submit';
